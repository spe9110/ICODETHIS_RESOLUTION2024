...
const users = [
    {
        id: 1,
        username: 'Chris',
        avatar: "https://shismqklzntzxworibfn.supabase.co/storage/v1/object/public/avatars/888e7b16-fa69-4576-9a45-d8f4fe6f6687.png"
    },
    {
        id: 2,
        username: "FlorinPop17",
        avatar: "https://shismqklzntzxworibfn.supabase.co/storage/v1/object/public/avatars/b31bde00-b6db-48e5-9798-1c0f053360d4.jpg"
    },
    {
        id: 3,
        username: 'Peter',
        avatar: "https://shismqklzntzxworibfn.supabase.co/storage/v1/object/public/avatars/9779712a-36d0-427f-8c6b-848bd059ed5f.png"
    },
    {
        id: 4,
        username: 'MIRZA_UIUX',
        avatar: "https://shismqklzntzxworibfn.supabase.co/storage/v1/object/public/avatars/5c07fc1c-4e73-4951-9157-a07e88fa6807.jpeg"
    },
    {
        id: 5,
        username: 'Kamil',
        avatar: "https://shismqklzntzxworibfn.supabase.co/storage/v1/object/public/avatars/3c467dfe-3c18-4d4a-9387-70cbe4429f11.png"
    },
    {
        id: 6,
        username: 'iMuhammad',
        avatar: "https://shismqklzntzxworibfn.supabase.co/storage/v1/object/public/avatars/a20a421f-fc09-4773-96e1-91ae719edb2b.jpg"
    },
    {
        id: 7,
        username: 'Mubiru_Angel',
        avatar: "https://shismqklzntzxworibfn.supabase.co/storage/v1/object/public/avatars/63639e2e-552f-41d7-ba3a-d1d5e0813d7e.png"
    },
    {
        id: 8,
        username: 'Rohit',
        avatar: "https://shismqklzntzxworibfn.supabase.co/storage/v1/object/public/avatars/e7026400-3b15-45d5-aef2-0994d40eae99.jpg"
    },
    {
        id: 9,
        username: 'AdityaZende',
        avatar: "https://shismqklzntzxworibfn.supabase.co/storage/v1/object/public/avatars/8b9bf09e-d755-4775-86eb-51aae8a6a0c0.jpeg"
    },
    {
        id: 10,
        username: 'neluttu',
        avatar: "https://shismqklzntzxworibfn.supabase.co/storage/v1/object/public/avatars/ef331e37-43e0-48bc-aa39-425ee8295f95.jpg"
    },
    {
        id: 11,
    ...
    },
    {
        id: 12,
        username: 'idocod3',
        avatar: "https://shismqklzntzxworibfn.supabase.co/storage/v1/object/public/avatars/06c26539-cd28-4686-a696-5f68174d1706.jpg"
    },
    {
        id: 14,
        username: 'bk7312',
    ...
    },
    {
        id: 15,
        username: 'Tony_Km',
        avatar: 'https://shismqklzntzxworibfn.supabase.co/storage/v1/object/public/avatars/d1b7d9bc-c3ac-4190-b829-d31d78282640.jpg'
    },
    {
        id: 16,
        username: 'Razoar',
        avatar: 'https://lh3.googleusercontent.com/a/AAcHTtd-mU6kxXBN8RAfXnG7uxdt2dobrlAw2RUOSY8CJuqkyw=s96-c'
    },
    {
        id: 18,
        username: 'christianodavid',
        avatar: ' https://shismqklzntzxworibfn.supabase.co/storage/v1/object/public/avatars/b5591a69-e87d-4081-84d0-f3213358e4fb.jpeg'
    }
...
¡gracias por tus comentarios!`
    },
    {
        ...
        user_id: 16,
        ts: 'Aug 30, 2023',
        msg: `its  awesome ...i m a beginner is there way i can understand how u pulled off the messages part`
    },
    {
        id: 63,
        parent_id: 62,
        ...
        ts: 'Aug 30, 2023',
        msg: ` Hi @Razoar
If you are referring as to how I got the messages, the answer is simple(and probably rather disappointing) - I copied and pasted them one by one from the challenges.

If you are referring as to how I loaded them, I saved them into a JavaScript array(object) and looped through them according to the user selected(which are held in another JavaScript array.`
    },
    ...
    },
    {
        ...
        user_id: 1,
        ts: 'Aug 30, 2023',
        msg: `Thanks @Rohit, I'm glad that you liked it 😄`
    },
    {
        id: 66,
        parent_id: 0,
        user_id: 18,
        ts: 'Aug 31, 2023',
        msg: `Nice job, Chris! It looks fantastic.`
    },
...
userSearch.addEventListener("keyup", (e) => {
    ...
    //if (str) {
        closeMessages()
        const items = users.filter(user => user.username.toLowerCase().includes(str))
...
/*
           ...
           // time = msg.ts;
            ...
            // get replies
            const replies = messages.filter(x => x.user_id === 1 && x.parent_id === msg.id);
            if (replies) { 
...
// add toggle theme off class (not when page loads)

//document.querySelector("#dark-bg").classList.add("[animation:_spinBack_3s_forwards]");
