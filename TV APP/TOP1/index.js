...
function renderItems() {
    ...
    if (filtered.length < 1) { 
        listMovies.innerHTML = "Sorry, we don't have any channels in this category at the moment";
    }
    //    console.log(i.cat);
        //return i.cat === selectedCat;
   ...
   // console.log(shuffledArr);
    ...
    shuffledArr.forEach(movie => {
        ...
        if (count < 6) {
            ...
            item.querySelector("[data-remaining]").innerText = `${remaining} min. remaining`
